  ...
  return (
    <footer>
      ...
      <div className="footer-links">
        ...
        <nav aria-label="Footer information links"><strong>Information</strong><a href="/history">BMX history</a><a href="/return-policy">Returns &amp; refunds</a><a href="/#confidence">Our standards</a><a href="/#process">How to buy</a><a href={emailLink("Support request", "Hello Craig's Bikes,\n\n")}>Contact support</a></nav>
